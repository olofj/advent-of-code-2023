...
up with 1 instance of card 1, 2 instances of card 2, 4 instances
of card 3, 8 instances of card 4, 14 instances of card 5, and 1
...
fn main() {
    let cards = include_str!("input-day04.txt")
        .lines()
    ...
    println!("total: {}", ncards.iter().sum::<usize>());
}
